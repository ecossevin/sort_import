...
ELSE   
 ...
 ELSE IF ( KRR == 1 ) THEN                           ! only vapor
  ...
  DO JK=1, IKT
    DO JIJ=IIJB, IIJE
      PETHETA(JIJ, JK) = 1. + ZDELTA*PRM(JIJ, JK, 1)
    END DO
  END DO
 ...
 ELSE                                                ! liquid water & ice present
  ...
  IF ( KRRI>0 ) THEN  ! rc and ri case
    ...
    DO JK=1, IKT
      DO JIJ=IIJB, IIJE
        ZRW(JIJ, JK) = ZRW(JIJ, JK) + PRM(JIJ, JK, 3)
      END DO
    END DO
    ...
    DO JRR=5,KRR
      DO JK=1, IKT
        DO JIJ=IIJB, IIJE
          ZRW(JIJ, JK) = ZRW(JIJ, JK) + PRM(JIJ, JK, JRR)
        END DO
      END DO
    ENDDO
    DO JK=1, IKT
      DO JIJ=IIJB, IIJE
        ZA(JIJ, JK) = 1. + (                                    &  ! Compute A
              (1.+ZDELTA) * (PRM(JIJ, JK, 1) - PRM(JIJ, JK, 2) - PRM(JIJ, JK, 4)) &
                  -ZRW(JIJ, JK)                                                &
                         )  /  (1. + ZRW(JIJ, JK))
        !
        !   Etheta = ZA + ZC * Atheta  
        ...
        !
        PETHETA(JIJ, JK) = ZA(JIJ, JK)                                                 &
            +( PLOCPEXNM(JIJ, JK) * ZA(JIJ, JK)                                        &
                   -(1.+ZDELTA) * (PTHLM(JIJ, JK) + PLOCPEXNM(JIJ, JK)*(               &
                                                        PRM(JIJ, JK, 2)+PRM(JIJ, JK, 4)))&
                                / (1. + ZRW(JIJ, JK))                                &
             ) * PATHETA(JIJ, JK) * 2. * PSRCM(JIJ, JK)
      END DO
    END DO
  ...
  ELSE
    ...
    DO JK=1, IKT
      DO JIJ=IIJB, IIJE
        ZA(JIJ, JK) = 1. + (                                    &  ! Compute A
              (1.+ZDELTA) * (PRM(JIJ, JK, 1) - PRM(JIJ, JK, 2)) &
                  -ZRW(JIJ, JK)                                 &
                         )  /  (1. + ZRW(JIJ, JK))
        !
        !   Etheta = ZA + ZC * Atheta  
        ...
        !
        PETHETA(JIJ, JK) = ZA(JIJ, JK)                                                 &
            +( PLOCPEXNM(JIJ, JK) * ZA(JIJ, JK) -(1.+ZDELTA) * (PTHLM(JIJ, JK) &
            + PLOCPEXNM(JIJ, JK)*PRM(JIJ, JK, 2))   &
             / (1. + ZRW(JIJ, JK))                                 &
             ) * PATHETA(JIJ, JK) * 2. * PSRCM(JIJ, JK)
      END DO
    END DO
