...
!
!
USE MODE_SHUMAN_PHY, ONLY : MZM_PHY, DXM_PHY, MZF_PHY, & 
& MXM_PHY, DZM_PHY 
...
DO JK=1, IKT
  DO JJ=IJB, IJE
    DO JI=IIB, IIE
      ZWORK3(JI, JJ, JK) = ZWORK2(JI, JJ, JK) / ZWORK1(JI, JJ, JK)
    END DO
  END DO
END DO
...
IF (.NOT. OFLAT) THEN
  ...
  DO JK=1, IKT
    DO JJ=IJB, IJE
      DO JI=IIB, IIE
        PGX_W_UW(JI, JJ, JK)= ZWORK3(JI, JJ, JK)    &
                       - ZWORK5(JI, JJ, JK)*PDZX(JI, JJ, JK)  &
                       / (ZWORK1(JI, JJ, JK)*ZWORK2(JI, JJ, JK))
      END DO
    END DO
  END DO
...
!
!
USE MODE_SHUMAN_PHY, ONLY : MZM_PHY, DYM_PHY, MZF_PHY, & 
& MYM_PHY, DZM_PHY 
USE MODD_DIMPHYEX, ONLY: DIMPHYEX_t
!
IMPLICIT NONE
...
IF (.NOT. OFLAT) THEN
  ...
  DO JK=1, IKT
    DO JJ=IJB, IJE
      DO JI=IIB, IIE
        PGY_W_VW(JI, JJ, JK)= ZWORK3(JI, JJ, JK)    &
                       - ZWORK5(JI, JJ, JK)*PDZY(JI, JJ, JK)  &
                       / (ZWORK1(JI, JJ, JK)*ZWORK2(JI, JJ, JK))
      END DO
    END DO
  END DO
...
DO JK=1, IKT
  DO JJ=IJB, IJE
    DO JI=IIB, IIE
      PGZ_W_M(JI, JJ, JK)= ZWORK1(JI, JJ, JK)/ZWORK2(JI, JJ, JK)    
    END DO
  END DO
END DO
