...
DO JK=1, IKT
  DO JJ=IJB, IJE
    DO JI=IIB, IIE
      PGZ_V_VW(JI, JJ, JK)= PA_WORK(JI, JJ, JK) &
                                                     / PDZZ_WORK(JI, JJ, JK)
    END DO
  END DO
END DO
...
!
!
USE MODE_SHUMAN_PHY, ONLY : DYF_PHY, MYF_PHY, DZM_PHY, & 
& MZF_PHY 
USE MODD_DIMPHYEX, ONLY: DIMPHYEX_t
!
IMPLICIT NONE
...
IF (.NOT. OFLAT) THEN
  ...
  DO JK=1, IKT
    DO JJ=IJB, IJE
      DO JI=IIB, IIE
        ZWORK3(JI, JJ, JK) = ZWORK3(JI, JJ, JK) * PDZY(JI, JJ, JK)
      END DO
    END DO
  END DO
  ...
  DO JK=1, IKT
    DO JJ=IJB, IJE
      DO JI=IIB, IIE
        PGY_V_M(JI, JJ, JK) = ( ZWORK1(JI, JJ, JK) - ZWORK3(JI, JJ, JK)) &
                                           / ZWORK2(JI, JJ, JK)
      END DO
    END DO
  END DO
...
ELSE
  ...
  DO JK=1, IKT
    DO JJ=IJB, IJE
      DO JI=IIB, IIE
        PGY_V_M(JI, JJ, JK)= ZWORK1(JI, JJ, JK) / ZWORK2(JI, JJ, JK)
      END DO
    END DO
  END DO
